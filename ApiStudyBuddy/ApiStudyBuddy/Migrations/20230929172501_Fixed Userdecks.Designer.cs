...
namespace ApiStudyBuddy.Migrations
{
    ...
    [Migration("20230929172501_Fixed Userdecks")]
    partial class FixedUserdecks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiStudyBuddy.Models.DeckGroup", b =>
                {
                    b.HasOne("ApiStudyBuddy.Models.UserDeckGroup", "UserDeckGroup")
                        .WithOne("DeckGroup")
                        .HasForeignKey("ApiStudyBuddy.Models.DeckGroup", "DeckGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
